    ...
    <section className="bg-white py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="relative overflow-hidden rounded-3xl bg-[#0F172A] p-12 lg:p-16">
          ...
          <div className="absolute -top-24 -right-24 w-[400px] h-[400px] rounded-full bg-[#5BA829]/20 blur-[100px]" />
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 lg:justify-end">
              <Link to="/book-demo" className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#5BA829] to-[#8CE036] text-[#0F172A] px-6 py-3 font-semibold shadow-[0_10px_40px_-10px_rgba(0,212,255,0.7)]">
