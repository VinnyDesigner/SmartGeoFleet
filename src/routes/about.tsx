...
const timeline = [
  { year: "2018", title: "mylr.ai founded", desc: "Started in Amsterdam with a mission to modernize fleet intelligence." },
  ...
  { year: "2026", title: "500,000+ vehicles", desc: "Today, mylr.ai powers operations across 120 countries." },
];
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — mylr.ai" },
      { name: "description", content: "mylr.ai is on a mission to give every fleet operator the intelligence layer they need to run safer, leaner and faster." },
      { property: "og:title", content: "About mylr.ai" },
...
function AboutPage() {
  return (
    <PageShell crumbs={[{ label: "About" }]}>
      <PageHero eyebrow="About" title="The intelligence layer for the world's fleets." subtitle="We build mylr.ai for the people who move the physical economy — the dispatchers, drivers and operators who keep things running." />
